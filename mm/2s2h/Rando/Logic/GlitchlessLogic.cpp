...
void ApplyGlitchlessLogicToSaveContext() {
    ...
    std::vector<RandoItemId> startingItems = {
        RI_SONG_STORMS,    RI_MASK_COUPLE,  RI_MASK_GARO,  RI_ARROW_LIGHT, RI_ARROW_ICE,      RI_SONG_OATH,
        RI_MASK_ALL_NIGHT, RI_SONG_LULLABY, RI_DEKU_STICK, RI_DEKU_NUT,    RI_PICTOGRAPH_BOX,
    };
