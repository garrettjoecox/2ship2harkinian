...
void ApplyGlitchlessLogicToSaveContext() {
    ...
    std::vector<RandoItemId> startingItems = {
        RI_MASK_GIBDO,  RI_SONG_STORMS, RI_MASK_COUPLE,    RI_SONG_LULLABY, RI_PICTOGRAPH_BOX, RI_MASK_GARO,
        RI_ARROW_LIGHT, RI_ARROW_ICE,   RI_MASK_ALL_NIGHT, RI_SONG_ELEGY,   RI_DEKU_STICK,     RI_DEKU_NUT,
    };
