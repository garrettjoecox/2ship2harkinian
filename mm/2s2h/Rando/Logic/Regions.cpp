...
std::unordered_map<RandoRegionId, RandoRegion> Regions = {
    ...
    { RR_GREATBAY_COAST_PIRATES_COVE, RandoRegion{ .name = "Pirate's Cove", .sceneId = SCENE_30GYOSON,
        .checks = {
            ...
            CHECK(RC_GREAT_BAY_COAST_HP,            CAN_HOOK_SCARECROW && HAS_ITEM(ITEM_MAGIC_BEANS) && (HAS_ITEM(ITEM_SPRING_WATER) || CHECK_QUEST_ITEM(QUEST_SONG_STORMS))),
    ...
    { RR_STONE_TOWER_MIDDLE, RandoRegion{ .name = "Middle", .sceneId = SCENE_F40,
        ...
        .checks = {
            ...
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_1, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_2, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_3, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_4, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_5, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_6, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_7, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_8, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_9, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_10, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_11, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
            CHECK(RC_STONE_TOWER_POT_LOWER_SCARECROW_12, CAN_BE_HUMAN && HAS_ITEM(ITEM_HOOKSHOT)),
        },
        .connections = {
    ...
    { RR_STONE_TOWER_INVERTED, RandoRegion{ .sceneId = SCENE_F41,
        .checks = {
            ...
            CHECK(RC_STONE_TOWER_INVERTED_POT_4, CAN_BE_HUMAN && HAS_ITEM(ITEM_MAGIC_BEANS) && (CHECK_QUEST_ITEM(QUEST_SONG_STORMS) || HAS_ITEM(ITEM_SPRING_WATER))),
