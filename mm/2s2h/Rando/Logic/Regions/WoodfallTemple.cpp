...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_WOODFALL_TEMPLE_BOSS_KEY_ROOM] = RandoRegion{ .name = "Boss Key Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_MINIBOSS_ROOM_POT_01, HAS_ITEM(ITEM_BOW) && (CAN_BE_DEKU || CAN_USE_EXPLOSIVE)),
            CHECK(RC_WOODFALL_TEMPLE_MINIBOSS_ROOM_POT_02, HAS_ITEM(ITEM_BOW) && (CAN_BE_DEKU || CAN_USE_EXPLOSIVE)),
            CHECK(RC_WOODFALL_TEMPLE_MINIBOSS_ROOM_POT_03, HAS_ITEM(ITEM_BOW) && (CAN_BE_DEKU || CAN_USE_EXPLOSIVE)),
            CHECK(RC_WOODFALL_TEMPLE_MINIBOSS_ROOM_POT_04, HAS_ITEM(ITEM_BOW) && (CAN_BE_DEKU || CAN_USE_EXPLOSIVE)),
        },
        .connections = {
    ...
    Regions[RR_WOODFALL_TEMPLE_MAP_ROOM] = RandoRegion{ .name = "Map Room", .sceneId = SCENE_MITURIN,
        .checks = {
            ...
            CHECK(RC_WOODFALL_TEMPLE_MAP_CHEST, CAN_BE_DEKU || CAN_USE_EXPLOSIVE),
        },
        .connections = {
