...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_GREAT_BAY_TEMPLE_ENTRANCE] = RandoRegion{ .sceneId = SCENE_SEA,
        .checks = {
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_01, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_02, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_03, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_04, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_05, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_06, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_07, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_ENTRANCE_BARREL_08, CAN_BREAK_BARREL),
    ...
    Regions[RR_GREAT_BAY_TEMPLE_GREEN_PIPE_1] = RandoRegion{ .sceneId = SCENE_SEA,
        .checks = {
            ...
            CHECK(RC_GREAT_BAY_TEMPLE_GREEN_PIPE_1_BARREL_01,             HAS_ITEM(ITEM_HOOKSHOT) && CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_GREEN_PIPE_1_BARREL_02,             HAS_ITEM(ITEM_HOOKSHOT) && CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_GREEN_PIPE_1_BARREL_03,             HAS_ITEM(ITEM_HOOKSHOT) && CAN_BREAK_BARREL),
        },
        .connections = {
    ...
    Regions[RR_GREAT_BAY_TEMPLE_GREEN_PIPE_2] = RandoRegion{ .sceneId = SCENE_SEA,
        .checks = {
            CHECK(RC_GREAT_BAY_TEMPLE_GREEN_PIPE_2_BARREL_01,   CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_GREEN_PIPE_2_BARREL_02,   CAN_BREAK_BARREL),
    ...
    Regions[RR_GREAT_BAY_TEMPLE_RED_PIPE_SWITCH_ROOM] = RandoRegion{ .sceneId = SCENE_SEA,
        .checks = {
            CHECK(RC_GREAT_BAY_TEMPLE_RED_PIPE_SWITCH_ROOM_BARREL_01, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_RED_PIPE_SWITCH_ROOM_BARREL_02, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_RED_PIPE_SWITCH_ROOM_BARREL_03, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_RED_PIPE_SWITCH_ROOM_BARREL_04, CAN_BREAK_BARREL),
            CHECK(RC_GREAT_BAY_TEMPLE_RED_PIPE_SWITCH_ROOM_BARREL_05, CAN_BREAK_BARREL),
