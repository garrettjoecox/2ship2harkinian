...
static RegisterShipInitFunc initFunc([]() {
    Regions[RR_BENEATH_THE_WELL_BABA_AND_POTS_ROOM] = RandoRegion{ .name = "Babas and Pots Room", .sceneId = SCENE_REDEAD,
        ...
        .connections = {
            ...
            CONNECTION(RR_BENEATH_THE_WELL_SKULLTULA_ROOM, RANDO_ACCESS[RANDO_ACCESS_BUGS] && HAS_ITEM(ITEM_MASK_GIBDO)),
            CONNECTION(RR_BENEATH_THE_WELL_FOUR_SPIKED_BARS, RANDO_ACCESS[RANDO_ACCESS_BIG_POE] && HAS_ITEM(ITEM_MASK_GIBDO))
        },
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_NUT_AMMO, true),
    ...
    Regions[RR_BENEATH_THE_WELL_BACK_EXIT] = RandoRegion{ .name = "Mirror Shield Room", .sceneId = SCENE_REDEAD,
        ...
        .connections = {
            CONNECTION(RR_BENEATH_THE_WELL_MIRROR_SHIELD_ROOM, true),
        },
    };
    Regions[RR_BENEATH_THE_WELL_BIG_POE_ROOM] = RandoRegion{ .name = "Big Poe Room", .sceneId = SCENE_REDEAD,
        ...
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_BIG_POE, HAS_BOTTLE && HAS_ITEM(ITEM_BOW)),
        }
    };
    Regions[RR_BENEATH_THE_WELL_COW_ROOM] = RandoRegion{ .name = "Cow Room", .sceneId = SCENE_REDEAD,
        ...
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_MILK, HAS_BOTTLE),
        }
    };
    Regions[RR_BENEATH_THE_WELL_DEXIHAND_ROOM] = RandoRegion{ .name = "Dexihand Room", .sceneId = SCENE_REDEAD,
        ...
        .events = {
            ...
            EVENT_ACCESS(RANDO_ACCESS_FISH, HAS_BOTTLE),
            EVENT_ACCESS(RANDO_ACCESS_HOT_SPRING_WATER, HAS_BOTTLE && HAS_ITEM(ITEM_BOW))
        },
    };
    ...
    Regions[RR_BENEATH_THE_WELL_FOUR_SPIKED_BARS] = RandoRegion{ .name = "Four Spikes Room", .sceneId = SCENE_REDEAD,
        .connections = {
            ...
            CONNECTION(RR_BENEATH_THE_WELL_MIRROR_SHIELD_ROOM, RANDO_ACCESS[RANDO_ACCESS_MILK] && HAS_ITEM(ITEM_MASK_GIBDO))
        },
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_BUGS, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
        }
    };
    Regions[RR_BENEATH_THE_WELL_FREEZARD_ROOM] = RandoRegion{ .name = "Freezard Room", .sceneId = SCENE_REDEAD,
        .connections = {
            ...
            CONNECTION(RR_BENEATH_THE_WELL_RIGHT_FIRE_KEESE, RANDO_ACCESS[RANDO_ACCESS_NUT_AMMO] && HAS_ITEM(ITEM_MASK_GIBDO)),
            CONNECTION(RR_BENEATH_THE_WELL_BABA_AND_POTS_ROOM, RANDO_ACCESS[RANDO_ACCESS_FISH] && HAS_ITEM(ITEM_MASK_GIBDO))
        },
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_SPRING_WATER, true),
            EVENT_ACCESS(RANDO_ACCESS_STICK_AMMO, true),
        }
    };
    ...
    Regions[RR_BENEATH_THE_WELL_MIRROR_SHIELD_ROOM] = RandoRegion{ .name = "Mirror Shield Room", .sceneId = SCENE_REDEAD,
        .checks = {
            ...
            CHECK(RC_BENEATH_THE_WELL_MIRROR_SHIELD, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE))
        },
        .connections = {
    ...
    Regions[RR_BENEATH_THE_WELL_RIGHT_FIRE_KEESE] = RandoRegion{ .name = "Right Fire Keese Room", .sceneId = SCENE_REDEAD,
        .connections = {
            ...
            CONNECTION(RR_BENEATH_THE_WELL_COW_ROOM, RANDO_ACCESS[RANDO_ACCESS_SPRING_WATER] && HAS_ITEM(ITEM_MASK_GIBDO))
        },
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_BUGS, HAS_BOTTLE && HAS_ITEM(ITEM_BOW)),
        }
    };
    Regions[RR_BENEATH_THE_WELL_SKULLTULA_ROOM] = RandoRegion{ .name = "Skulltula Room", .sceneId = SCENE_REDEAD,
        .checks = {
            CHECK(RC_BENEATH_THE_WELL_SKULLTULLA_CHEST, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
        },
        .connections = {
            CONNECTION(RR_BENEATH_THE_WELL_BABA_AND_POTS_ROOM, true), 
        }
    ...
    Regions[RR_BENEATH_THE_WELL_THREE_SPIKED_BARS] = RandoRegion{ .name = "Three Spikes Room", .sceneId = SCENE_REDEAD,
        .connections = {
            ...
            CONNECTION(RR_BENEATH_THE_WELL_DEXIHAND_ROOM, RANDO_ACCESS[RANDO_ACCESS_FISH] && HAS_ITEM(ITEM_MASK_GIBDO))
        },
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_SPRING_WATER, true),
            EVENT_ACCESS(RANDO_ACCESS_FISH, HAS_BOTTLE)
    ...
    Regions[RR_BENEATH_THE_WELL_TWO_SPIKED_BARS] = RandoRegion{ .name = "Two Spikes Room", .sceneId = SCENE_REDEAD,
        .checks = {
            CHECK(RC_BENEATH_THE_WELL_POT_LEFT_SIDE_1, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
            CHECK(RC_BENEATH_THE_WELL_POT_LEFT_SIDE_2, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
            CHECK(RC_BENEATH_THE_WELL_POT_LEFT_SIDE_3, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
            CHECK(RC_BENEATH_THE_WELL_POT_LEFT_SIDE_4, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
            CHECK(RC_BENEATH_THE_WELL_POT_LEFT_SIDE_5, RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE)),
        },
        .connections = {
            CONNECTION(RR_BENEATH_THE_WELL_THREE_SPIKED_BARS, true),
            CONNECTION(RR_BENEATH_THE_WELL_FAIRY_FOUNTAIN, RANDO_ACCESS[RANDO_ACCESS_BUGS] && HAS_ITEM(ITEM_MASK_GIBDO)),
            CONNECTION(RR_BENEATH_THE_WELL_LEFT_FIRE_KEESE, RANDO_ACCESS[RANDO_ACCESS_BUGS] && HAS_ITEM(ITEM_MASK_GIBDO)),
        },
        .events = {
            EVENT_ACCESS(RANDO_ACCESS_BUGS, HAS_BOTTLE && (RANDO_ACCESS[RANDO_ACCESS_STICK_AMMO] || CAN_USE_MAGIC_ARROW(FIRE))),
        },
    };
}, {});
// clang-format on
