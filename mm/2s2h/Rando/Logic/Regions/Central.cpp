...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_TERMINA_FIELD] = RandoRegion{ .sceneId = SCENE_00KEIKOKU,
        .checks = {
            ...
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_1,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_2,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_3,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_4,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_5,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_6,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_7,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_8,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
            CHECK(RC_TERMINA_FIELD_GUAY_RUPEE_DROP_9,  CAN_PLAY_SONG(SONATA) || CAN_PLAY_SONG(LULLABY) || CAN_PLAY_SONG(BOSSA_NOVA)),
