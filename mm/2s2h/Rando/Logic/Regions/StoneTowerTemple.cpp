...
static RegisterShipInitFunc initFunc([]() {
    ...
    Regions[RR_STONE_TOWER_TEMPLE_SPIKED_BAR_ROOM_LOWER] = RandoRegion{ .name = "Spiked Bar Room Lower", .sceneId = SCENE_INISIE_N,
        .checks = {
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM1, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM2, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM3, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM4, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM5, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM6, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM7, true),
            CHECKRC_STONE_TOWER_TEMPLE_POT_SPIKED_BAR_ROOM8, true),
        },
        .connections = {
