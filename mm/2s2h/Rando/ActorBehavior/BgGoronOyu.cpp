...
// When BgGoronOyu is initialized this means the player should now be considered to have access to Hot Spring Water.
// This flag is purely to drive the live updating check tracker, it has no effect on actual gameplay.
