...
typedef enum {
    ...
    RANDO_INF_HAS_ACCESS_TO_BUGS,
    RANDO_INF_HAS_ACCESS_TO_FISH,
    RANDO_INF_HAS_ACCESS_TO_SEAHORSE,
    // Not sure if this is the best way to go about these
    RANDO_INF_HAS_ACCESS_TO_PIRATE_EGG_1,
    RANDO_INF_HAS_ACCESS_TO_PIRATE_EGG_2,
    RANDO_INF_HAS_ACCESS_TO_PIRATE_EGG_3,
    RANDO_INF_HAS_ACCESS_TO_PIRATE_EGG_4,
    RANDO_INF_HAS_ACCESS_TO_PINNACLE_EGGS,
    RANDO_INF_CAN_TAKE_PICTURE_OF_PIRATE,
    RANDO_INF_CAN_TAKE_PICTURE_OF_TINGLE_OR_DEKU_KING,
    RANDO_INF_MAX,
} RandoInf;
