...
typedef enum {
    ...
    RR_PIRATES_FORTRESS_INT_SEWERS_PREGATE,
    RR_PIRATES_FORTRESS_INT_SEWERS_POSTGATE,
    RR_PIRATES_FORTRESS_INT_TELESCOPE_ROOM,
    RR_PIRATES_FORTRESS_INNER_OUTSIDE_LOWER,
    RR_PIRATES_FORTRESS_INNER_OUTSIDE_TOWER,
    RR_PIRATES_FORTRESS_INNER_OUTSIDE_LEFT,
    RR_PIRATES_FORTRESS_INNER_INSIDE_LINE_GUARD,
    RR_PIRATES_FORTRESS_INNER_INSIDE_ORANGE_GUARD,
    RR_PIRATES_FORTRESS_INNER_INSIDE_CHEST_EGG_ROOM,
    RR_PIRATES_FORTRESS_INNER_INSIDE_4_GUARD_ROOM,
    RR_PIRATES_FORTRESS_INNER_INSIDE_PURPLE_GUARD,
    RR_PIRATES_FORTRESS_LEFT_CLAM_EGG_ROOM,
    RR_PIRATES_FORTRESS_INNER_OUTSIDE_RIGHT,
    RR_PIRATES_FORTRESS_INNER_INSIDE_MAZE_GUARD,
    RR_PIRATES_FORTRESS_INNER_INSIDE_GREEN_GUARD,
    RR_PIRATES_FORTRESS_RIGHT_CLAM_EGG_ROOM,
    RR_PIRATES_FORTRESS_LEADER_ROOM_UPPER,
    RR_PIRATES_FORTRESS_LEADER_ROOM_LOWER,
    RR_POST_OFFICE,
    RR_RANCH_BARN,
    RR_RANCH_HOUSE,
